...
TEST_CASE("uri_test")
{
  SECTION("should parse the sub-delims")
  {
    ...
    auto const matched_all_sub_delims =
      std::all_of(delims.begin(), delims.end(), [](auto const delim) -> bool {
        ...
        return x3::parse(begin, end, launchdarkly::foxy::uri::sub_delims);
      });
    ...
    auto const non_match = !x3::parse(begin, end, launchdarkly::foxy::uri::sub_delims);
  ...
  SECTION("should parse the gen-delims")
  {
    ...
    auto const matched_all_gen_delims =
      std::all_of(delims.begin(), delims.end(), [](auto const delim) -> bool {
        ...
        return x3::parse(begin, end, launchdarkly::foxy::uri::gen_delims);
      });
    ...
    auto const non_match = !x3::parse(begin, end, launchdarkly::foxy::uri::gen_delims);
  ...
  SECTION("should parse the reserved")
  {
    ...
    auto const matched_all_reserved =
      std::all_of(delims.begin(), delims.end(), [](auto const delim) -> bool {
        ...
        return x3::parse(begin, end, launchdarkly::foxy::uri::reserved);
      });
...

    {
      ...
      auto const non_match = !x3::parse(begin, end, launchdarkly::foxy::uri::reserved);
...

    {
      ...
      auto const match = x3::parse(begin, end, +launchdarkly::foxy::uri::unreserved);
  ...
  SECTION("should support percent encoded parsing")
  {
    ...
    auto const match = x3::parse(begin, end, launchdarkly::foxy::uri::pct_encoded);
  ...
  SECTION("should support the pchar")
  {
    ...
    //
    {
      ...
      auto const match = x3::parse(begin, end, +launchdarkly::foxy::uri::pchar);
    ...
    //
    {
      ...
      auto const matched_all_sub_delims =
        std::all_of(delims.begin(), delims.end(), [](auto const delim) -> bool {
          ...
          return x3::parse(begin, end, launchdarkly::foxy::uri::pchar);
        });
  ...
  {
    {
      ...
      auto const match1 = x3::parse(begin, end, launchdarkly::foxy::uri::query);

      begin             = view.begin();
      auto const match2 = x3::parse(begin, end, launchdarkly::foxy::uri::fragment);
  ...
  SECTION("should support decimal octet parsing")
  {
    ...
    auto const all_match =
      std::all_of(valid_inputs.begin(), valid_inputs.end(), [](auto const view) -> bool {
        ...
        auto const match = x3::parse(begin, end, launchdarkly::foxy::uri::dec_octet);
  ...
  SECTION("should support IPv4 address parsing")
  {
    ...
    auto const all_match =
      std::all_of(valid_inputs.begin(), valid_inputs.end(), [](auto const view) -> bool {
        ...
        auto const match = x3::parse(begin, end, launchdarkly::foxy::uri::ip_v4_address);
  ...
  SECTION("should support IPv6 address parsing")
  {
    ...
    auto const all_match =
      std::all_of(valid_inputs.begin(), valid_inputs.end(), [](auto const view) -> bool {
        ...
        auto const match      = x3::parse(begin, end, launchdarkly::foxy::uri::ip_v6_address);
        auto const full_match = match && (begin == end);
  ...
  SECTION("should support URI parsing")
  {
    ...
    auto const all_match =
      std::all_of(valid_inputs.begin(), valid_inputs.end(), [](auto const view) -> bool {
        ...
        auto const match      = x3::parse(begin, end, launchdarkly::foxy::uri::uri);
        auto const full_match = match && (begin == end);
