...
//
// written by Damian Jarek, distributed under the Boost Software License found
// here in the source:
// https://github.com/djarek/certify/blob/b5d8b2ed67fd12437e8b2f104477b2d06c3d6803/LICENSE_1_0.txt
//
// without their tireless research, Foxy wouldn't be nearly as secure or useful
// as it is
//
namespace certify {
...
void set_sni_hostname(AsyncSSLStream& stream,
...
template <class AsyncSSLStream>
void set_sni_hostname(AsyncSSLStream& stream, std::string const& hostname) {
