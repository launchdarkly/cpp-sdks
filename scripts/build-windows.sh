...
mkdir -p release
cmake -G Ninja -D CMAKE_BUILD_TYPE=Debug -D LD_BUILD_TESTING=OFF -D CMAKE_INSTALL_PREFIX=./release ..
...
mkdir -p release
cmake -G Ninja -D CMAKE_BUILD_TYPE=Debug -D LD_BUILD_TESTING=OFF -D LD_BUILD_SHARED_LIBS=ON -D CMAKE_INSTALL_PREFIX=./release ..
