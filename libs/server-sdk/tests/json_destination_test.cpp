...
TEST_F(JsonDestinationTest, Instantiation) {}
//
...
// // transformation consists of two parts; first, serializing items to JSON,
// and
...
//                                   data_model::Segment{"segment_alpha",
//                                   1})}}});
// }
//
...
//                SerializedItemDescriptor::Absent(
//                    2,
//                    "{\"key\":\"segment\",\"version\":2,\"deleted\":true}")))
//         .WillOnce(Return(ISerializedDestination::UpsertResult::kSuccess));
//
...
//                        SerializedItemDescriptor::Present(
//                            2,
//                            "{\"on\":true,\"key\":\"flag\",\"version\":2}")))
//         .WillOnce(Return(ISerializedDestination::UpsertResult::kSuccess));
//
//     dest.Upsert("flag",
//                 data_model::FlagDescriptor(data_model::Flag{"flag", 2,
//                 true}));
// }
//
