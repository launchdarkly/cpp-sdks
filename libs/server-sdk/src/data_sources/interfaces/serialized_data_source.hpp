...
class ISerializedDataSource {
   public:
    virtual ~ISerializedDataSource() = default;
    ISerializedDataSource(ISerializedDataSource const& item) = delete;
    ISerializedDataSource(ISerializedDataSource&& item) = delete;
    ISerializedDataSource& operator=(ISerializedDataSource const&) = delete;
    ISerializedDataSource& operator=(ISerializedDataSource&&) = delete;
